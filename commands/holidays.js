...
function holidays(args, channel) {
    switch(args[1]) {
                        
        //gives the time since school started
        case 'start':
            const schoolStartEmbed = new Discord.MessageEmbed()
                .setTitle('Time Since School Started')
                .addField('First Day', 'August 24, 2020', false)
                .addField('Time Since:', `${timeSinceSchoolStarted()[0]} days, ${timeSinceSchoolStarted()[1]} hours, and ${timeSinceSchoolStarted()[2]} minutes!`, false)
                .setColor(0x2874a6)
                .setThumbnail('https://www.vwcs.net/userfiles/-23/my%20files/vwcs_circle_full-color.png?id=998')
            channel.send(schoolStartEmbed);
        break;

        //gives the time until school ends
        case 'end':
            const schoolEndEmbed = new Discord.MessageEmbed()
                .setTitle('Time Until School Ends')
                .addField('Last Day', 'May 20, 2021', false)
                .addField('Time Until:', `${timeUntilSchoolEnds()[0]} days, ${timeUntilSchoolEnds()[1]} hours, and ${timeUntilSchoolEnds()[2]} minutes!`, false)
                .setColor(0x2874a6)
                .setThumbnail('https://www.vwcs.net/userfiles/-23/my%20files/vwcs_circle_full-color.png?id=998')
        ...
        case 'christmas':
            const christmasBreakEmbed = new Discord.MessageEmbed()
                .setTitle('Time Until Christmas Break')
                .addField('Christmas Break', 'December 23, 2020', false)
                .addField('Time Until:', `${timeUntilChristmasBreak()[0]} days, ${timeUntilChristmasBreak()[1]} hours, and ${timeUntilChristmasBreak()[2]} minutes!`, false)
                .setColor(0x2874a6)
        ...
        case 'spring':
            const springBreakEmbed = new Discord.MessageEmbed()
                .setTitle('Time Until Spring Break')
                .addField('Spring Break', 'March 13, 2021', false)
                .addField('Time Until Spring Break:', `${timeUntilSpringBreak()[0]} days, ${timeUntilSpringBreak()[1]} hours, and ${timeUntilSpringBreak()[2]} minutes!`, false)
                .setColor(0x2874a6)
